...
#define AWS_IOT_MQTT_HOST              "a3l8rpjg868svp.iot.eu-central-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
...
#define AWS_IOT_MQTT_CLIENT_ID         "dt-ufo-01" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME          "dt-ufo-01" ///< Thing Name of the Shadow this device is associated with
